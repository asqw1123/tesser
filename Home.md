...
[tesseract-ocr-setup-3.05.01.exe](https://digi.bib.uni-mannheim.de/tesseract/tesseract-ocr-setup-3.05.01.exe) and [tesseract-ocr-setup-4.0.0-alpha.20180109.exe](https://digi.bib.uni-mannheim.de/tesseract/tesseract-ocr-setup-4.0.0-alpha.20180109.exe) (experimental). There are also [older versions](https://digi.bib.uni-mannheim.de/tesseract/) available.
