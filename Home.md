...
History:
* 2018-09-12 Update Tesseract 4.0.0. Mainly bug fixes, see [list of commits](https://github.com/UB-Mannheim/tesseract/commits/v4.0.0-beta.4.20180912). For the 64 bit, some executables don't work because of missing DLL files.
